...
| --- | --- | --- | --- |
Icône de coeur | .icon-favorite .like | .icon-heart | Le mot-clé "icon-favorite" ne représente pas bien l’image, car une icône de coeur peut être utilisée à des fins différentes (d’où le nom “icon-heart”).<br><br>Idem pour le mot-clé “like”, qui reste beaucoup trop spécifique et qui ne représente pas l’image de coeur. |
